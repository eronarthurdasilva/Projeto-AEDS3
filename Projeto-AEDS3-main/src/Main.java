...
public class Main {
    ...
    public static void carregarCSV(String filePath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath));
            ...
            System.out.println("Total de transações gravadas: " + totalGravadas);
        } catch (IOException e) {
            System.out.println("Erro ao carregar CSV: " + e.getMessage());

        }
        
        reconstruirIndice(); // Reconstrói o índice após carregar os dados
    }
    ...
    public static void update() throws IOException {
        ...
        try (RandomAccessFile raf = new RandomAccessFile(FILENAME, "rw")) {
            ...
            Transaction txTransaction = new Transaction(id, "", newAmount, newType, "", 0, "", "", "", false, 0, 0, 0,
                    0, "", 0, 0, "", 0, false, false);
